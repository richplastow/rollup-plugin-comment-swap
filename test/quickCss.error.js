...
test('quickCss() error: Literal After', t => {
...
test('quickCss() error: Literal Before', t => {
...
test('quickCss() error: Ternary Placement', t => {
...
test('quickCss() error: Ternary Syntax', t => {
...
test('quickCss() error: Variable Before', t => {
